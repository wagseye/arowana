...
export default class TestObjectSequenceTriggers {
  static async testObjSequenceForNewOrgs() {
    ...
    res =
      await Database.runSql(`SELECT organization_key, object_prefix, start, next, increment, max 
  ...
  static async testGenerateNewRecordId() {
    ...
    await Database.runSql(`INSERT INTO objects (id, organization_id, name, label, label_plural, table_schema, table_name, prefix) VALUES
  ...
  static async testTableName() {
    ...
    const objs =
      await Database.runSql(`INSERT INTO objects (id, organization_id, name, label, label_plural, table_schema, prefix) VALUES
